...
xs=seq(0,10,by=.2)  # the 'time' step to integrate upon, arbitrary increments
state=c(y=0); 

# Step 3: call the ode function to generate the simulation, based on set initial conditions
